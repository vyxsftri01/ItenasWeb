                ...
                <div class="card-body">
                    <form method="POST" action="{{ route('register') }}">
                        ...
                        <div class="row mb-3">
                            ...
                            <div class="col-md-6">
                                <input id="nomorinduk" type="text" class="form-control @error('nomorinduk') is-invalid @enderror" name="nomorinduk" value="{{ old('nomorinduk') }}" required autocomplete="nomorinduk" autofocus>
                        ...
                        <div class="row mb-3">
                            <label for="no_tlp" class="col-md-4 col-form-label text-md-end">{{ __('No Tlp') }}</label>
